...
if($shift['has_break']){
    ...
    $is_break_time_window = ($now >= $break_start && $now <= $break_end);
}else{
    $is_break_time_window = false;
}
...
<div class="main-content">
    <div class="dashboard" style="margin: 40px auto; max-width: 900px;">
                                ...
                                <?php else: ?>
                                    <div class="info-chip" style="width: 280px; height: 75px; border-radius: 20px; justify-content: center; background: #fafafa; border: 1px dashed #e2e8f0;">
                                        ...
                                        <span style="color: #94a3b8;">
                                            ...
                                            <?php 
                                                if($shift['has_break']){
                                                    echo date('h:i A', strtotime($shift['break_start'])) 
                                                    . " - " . 
        ...
        <div class="glass-panel" style="padding:30px; border-radius:30px; margin-bottom:30px;">
            ...
            <?php if($permissions->num_rows > 0): ?>
                        ...
                        ">
                            <div>
                                ...
                                <div style="font-size:13px; color:#64748b;">
                                    من <?php echo $p['from_time']; ?> إلى <?php echo $p['to_time']; ?>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <?php else: ?>
                                    <span style="color:#f59e0b; font-weight:700;">⏳ تحت المراجعة</span>
                                <?php endif; ?>
                            </div>
                        </div>
                    <?php endwhile; ?>
                ...
                <div style="margin-top:15px; text-align:center;">
                    <a href="employee/permissions" style="color:var(--primary); font-weight:700;">
                        عرض كل الأذونات →
                    </a>
                </div>
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 25px;">
            ...
            <a href="employee/leave_requests" class="action-card" style="background: white; padding: 35px; border-radius: 30px; text-decoration: none; text-align: center; border: 1px solid #f1f5f9;">
                <div style="width:70px;height:70px;background:#fff7ed;border-radius:20px;display:flex;align-items:center;justify-content:center;margin:0 auto 20px;">
                    <i class="fas fa-plane" style="font-size:30px;color:#f59e0b;"></i>
                </div>
                <span style="font-weight:800;color:#1e293b;font-size:18px;">طلب إجازة</span>
            </a>
            <a href="employee/notifications" class="action-card" style="position:relative; background:white; padding:35px; border-radius:30px; text-decoration:none; text-align:center; border:1px solid #f1f5f9;">
                ...
                <div style="width:70px;height:70px;background:#fee2e2;border-radius:20px;display:flex;align-items:center;justify-content:center;margin:0 auto 20px;">
                    <i class="fas fa-bell" style="font-size:30px;color:#ef4444;"></i>
                </div>

                <span style="font-weight:800;color:#1e293b;font-size:18px;">الإشعارات</span>
                <p style="color:#64748b;font-size:14px;margin-top:8px;">
                    متابعة حالة الأذونات والإجازات الخاصة بك
                </p>
