...
<div class="sidebar-pro" id="sidebar">
    ...
    <ul class="menu">
        ...
        <?php if($_SESSION['role'] == 'admin'): ?>
            ...
            <?php $nav = navActive('permissions', $current); ?>
            <li>
                <a href="/admin/permissions" class="<?= $nav['class']; ?>">
            ...
            <?php $nav = navActive('leave_requests', $current); ?>
            <li>
                <a href="/admin/leave_requests" class="<?= $nav['class']; ?>">
        ...
        <?php else: ?>
            ...
            <?php $nav = navActive('permissions', $current); ?>
            <li>
                <a href="/employee/permissions" class="<?= $nav['class']; ?>">
                    <i class="fas fa-clock"></i>
                    <span>أذوناتي</span>
                    <?= $nav['pill']; ?>
                </a>
            ...
            <?php $nav = navActive('leave_requests', $current); ?>
            <li>
                <a href="/employee/leave_requests" class="<?= $nav['class']; ?>">
