            ...
            <table style="width: 100%; border-collapse: collapse;">
                <thead style="background: var(--primary); color: white;">
                    <tr>
                        ...
                        <th style="padding: 15px 20px; text-align: center;">النوع</th>
                ...
                <tbody>
                    ...
                    <tr style="border-bottom: 1px solid rgba(0,0,0,0.03); transition: all 0.3s ease;" class="employee-row">
                       ...
                       <td style="padding: 20px; text-align: center;">
                        ...
                        <td style="padding: 20px; text-align: center;">
                            <?php if($row['nationality_type'] == 'saudi'): ?>
                                <span style="background:#ecfdf5;color:#16a34a;padding:5px 12px;border-radius:10px;font-size:12px;font-weight:700;">
                                    سعودي
                                </span>
                            <?php else: ?>
                                <span style="background:#eff6ff;color:#2563eb;padding:5px 12px;border-radius:10px;font-size:12px;font-weight:700;">
                                    مغترب
                                </span>
                            <?php endif; ?>
                        </td>
                        <td style="padding: 20px; text-align: center;">
                            <div style="display: flex; gap: 8px; justify-content: center;">
                                <?php if($row['role'] != 'admin'): ?>
                                    <a href="edit_employee?id=<?php echo $row['id']; ?>" class="btn-action" style="color: #F97316; background: #eef2ff;" title="تعديل">
