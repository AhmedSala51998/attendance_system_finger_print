...
if ($res->num_rows > 0) {
    ...
    if ($now < $end_time) {
        $display_end = ($shift['end_time'] == '21:00:00') ? '09:00 مساءً' : '07:00 مساءً';
    ...
    $actual_work_minutes = $total_presence_minutes - $break_deduction - $interruption_deduction - $late_break_deduction;
